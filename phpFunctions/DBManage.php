...
//    return "TRUE";
  ...
  function ParesQueVieronLaMismaPelicula() {
    ...
    $_queryParesPeliculas = "SELECT DISTINCT PQV1.USUARIO, PQV2.USUARIO FROM PELIS_QUE_VIO PQV1, PELIS_QUE_VIO PQV2 WHERE NOT EXISTS (SELECT 'X' FROM PELIS_QUE_VIO PQV3 WHERE PQV1.USUARIO = PQV3.USUARIO AND NOT EXISTS (SELECT 'X' FROM PELIS_QUE_VIO PQV4 WHERE PQV3.PELICULA_ID = PQV4.PELICULA_ID AND PQV4.USUARIO = PQV2.USUARIO)) AND PQV1.USUARIO > PQV2.USUARIO UNION SELECT DISTINCT PQV1.USUARIO, PQV2.USUARIO FROM PERSONA PQV1, PERSONA PQV2 WHERE 0 = (SELECT COUNT(*) FROM PELIS_QUE_VIO PQV5 WHERE PQV1.USUARIO = PQV5.USUARIO) AND 0 = (SELECT COUNT(*) FROM PELIS_QUE_VIO PQV6 WHERE PQV2.USUARIO = PQV6.USUARIO) AND PQV1.USUARIO > PQV2.USUARIO";
